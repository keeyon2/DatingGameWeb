...
(function() {
  ...
  Game = (function() {
    ...
    Game.prototype.createAttributeList = function() {
      return fs.readFile('attributes', 'utf8', (function(_this) {
        return function(err, data) {
          var fileText, i, index, randomIndex, ref, textArray, usableAttributes;
          fileText = data;
          textArray = fileText.split("\n");
          textArray.pop();
          usableAttributes = [];
          for (index = i = 1, ref = _this.N; 1 <= ref ? i <= ref : i >= ref; index = 1 <= ref ? ++i : --i) {
          ...
          return _this.attributeList = usableAttributes;
        };
      })(this));
    };
    ...
    Game.prototype.updateGUI = function(mmCandidate, pCandidate, score) {
      var currentWeight, data, dataWithScoreObj, i, index, mWeight, pWeight, ref, vAndF;
      data = [];
      for (index = i = 0, ref = this.N - 1; 0 <= ref ? i <= ref : i >= ref; index = 0 <= ref ? ++i : --i) {
        currentWeight = [];
        vAndF = {
          v: index,
          f: this.attributeList[index]
        };
